...
content_img = image_loader('main/static/imgs/.jpg', (300, 300))
style_img = image_loader('main/media/.jpg', (300, 300))
...
style_img = image_loader('./imgs/rain_princess.jpg', (300, 300))
...
save_image(output.cpu().detach()[0], './outputimg/output_28.png')
print('이미지 파일 저장을 완료했습니다.')

from IPython.display import Image

Image('./outputimg/output_28.png')
Image('./media/images/.jpg') # 추가한 코드
